...
APP_TITLE = "34401A NVRAM Viewer v0.8 English + Refined SCPI Console"
SCALE_Q23 = 8_388_608
...
class NvramImage:
    ...
    def overview_text(self) -> str:
        ...
        lines = [
            "34401A NVRAM Viewer v0.8 English — ANALYSIS + REFINED SCPI CONSOLE",
            "=" * 68,
            f"File: {self.path}",
...
class NvramViewer(tk.Tk):
    ...
    def load_calstr_from_dump(self, use_comparison: bool) -> None:
        ...
        self.generate_calstr_commands()
        self.status_var.set(f"Loaded calibration string from {label} dump and updated the editor template.")
    ...
    def export_csv(self) -> None:
        ...
        try:
            with open(path, "w", newline="", encoding="utf-8-sig") as handle:
                ...
                writer.writerow(["34401A NVRAM Viewer v0.8 English — ANALYSIS + REFINED SCPI CONSOLE export"])
