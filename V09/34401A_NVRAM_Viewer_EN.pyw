...
APP_TITLE = "34401A NVRAM Viewer v0.9 English + CAL:STR Decode Fix"
SCALE_Q23 = 8_388_608
...
class NvramImage:
    ...
    def overview_text(self) -> str:
        ...
        lines = [
            "34401A NVRAM Viewer v0.9 English — ANALYSIS + CAL:STR FIELD DECODER",
            "=" * 72,
            f"File: {self.path}",
...
class NvramViewer(tk.Tk):
    ...
    def validate_calstr_text(self, text: str) -> Optional[str]:
        if not text:
            return "Cal String to Write is empty. Enter 1–40 printable ASCII characters."
        if len(text) > 40:
    ...
    def load_cal_assistant_block(self) -> None:
        ...
        self.calstr_status_var.set("Loaded the current SCPI CAL Assistant command block into the editable console script.")
        self.calstr_template_state_var.set(
            "Console currently contains the SCPI CAL Assistant block; it is independent of the CAL:STR helper inputs."
        )
        self.status_var.set("SCPI CAL Assistant block loaded into the console editor.")
    ...
    def export_csv(self) -> None:
        ...
        try:
            with open(path, "w", newline="", encoding="utf-8-sig") as handle:
                ...
                writer.writerow(["34401A NVRAM Viewer v0.9 English — ANALYSIS + CAL:STR FIELD DECODER export"])
